...
import '@yumyumswap/contract-core/contracts/libraries/SafeCast.sol';
import '@yumyumswap/contract-core/contracts/libraries/TickMath.sol';
import '@yumyumswap/contract-core/contracts/libraries/TickBitmap.sol';
import '@yumyumswap/contract-core/contracts/interfaces/IYumyumSwapPool.sol';
import '@yumyumswap/contract-core/contracts/interfaces/callback/IYumyumSwapSwapCallback.sol';
...
contract QuoterV2 is IQuoterV2, IYumyumSwapSwapCallback, PeripheryImmutableState {
    using Path for bytes;
    using SafeCast for uint256;
    using PoolTicksCounter for IYumyumSwapPool;
    ...
    /// @inheritdoc IYumyumSwapSwapCallback
    function yumyumswapSwapCallback(
        ...
        IYumyumSwapPool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IYumyumSwapPool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
