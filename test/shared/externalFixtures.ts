...
import { IYumyumSwapFactory, IWETH9, MockTimeSwapRouter } from '../../typechain'
...
const v3CoreFactoryFixture: Fixture<IYumyumSwapFactory> = async ([wallet]) => {
  return (await waffle.deployContract(wallet, {
    bytecode: FACTORY_BYTECODE,
    abi: FACTORY_ABI,
  })) as IYumyumSwapFactory
}
